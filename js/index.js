...
$(document).ready(function(){
	...
	window.signInFunction = function signInFunction() {
...
// SENDS USER TO CHROME STORE IF USER CLICKS 'DOWNLOAD' BUTTON
$(document).ready(function() {
	$('#downloadLink').click(function() {
		window.open("https://chrome.google.com/webstore/detail/timem/pbhgmbbhlhoeinmiacknanmmclilciab");
	});
});
